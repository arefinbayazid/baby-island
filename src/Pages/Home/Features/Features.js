...
const Features = () => {
    return (
        ...
        <div id="features" className="md:flex flex-wrap justify-center items-center text-center gap-8">
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-white mt-6  shadow-lg rounded-lg dark:bg-gray-800">
                <div className="flex-shrink-0">
                    <div className="flex items-center mx-auto justify-center h-12 w-12 rounded-md bg-pink-500 text-white">
                ...
                <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
                    A necessary bath toys for both parents and kids.Not only it can relieve the trouble when you want your babies to bathtub voluntarily,but also toddlers will fall in love with the bath time.
                </p>
            </div>
            ...
            <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mt-6  px-4 py-4 bg-white shadow-lg rounded-lg dark:bg-gray-800">
                ...
                <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
                    lashing Colourful Light and cute appearance design, easy to draw your kids attention, Fun bath toy to entice your child into taking baths.
                </p>
            </div>
        </div>
